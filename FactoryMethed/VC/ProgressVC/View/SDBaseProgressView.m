...
- (void)setCenterProgressText:(NSString *)text withAttributes:(NSDictionary *)attributes
{
    ...
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 7.0) {
        ...
        if (attributes[NSFontAttributeName]) {
            ...
            strSize = [text boundingRectWithSize:CGSizeMake(320, 100) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading  attributes:@{NSFontAttributeName: attributes[NSFontAttributeName]} context:nil].size;
//            strSize = [text sizeWithFont:attributes[NSFontAttributeName]];
            attrStr = [[NSAttributedString alloc] initWithString:text attributes:attributes];
             ...
             strSize = [text boundingRectWithSize:CGSizeMake(320, 100) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading  attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:[UIFont systemFontSize]]} context:nil].size;
